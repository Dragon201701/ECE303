...
%  last revision 17 January 2002 - revision 1.1
...
load('C:\DSP_Text\Matlab\App_MatlabMisc\LPfilter.mat'); % loads the LP filter data structure
...
if wavDesired(1) == 'y' | wavDesired(1) == 'Y'
    wavwrite(ScaledAM_msg, Fs, Nbits, 'C:\MATLAB6p1\work\wavFiles\AMwavform.wav')
