...
{                    
	...
	if(++DecimationIndex >= DecimationFactor) { // use sample?
		...
		// LED 1 logic
		if ((outputLeft > 28000)||(outputLeft < -28000)||(outputRight > 28000)||(outputRight < -28000)) {
		...
		// LED 2 logic
		if ((outputLeft > 32000)||(outputLeft < -32000)||(outputRight > 32000)||(outputRight < -32000)) {
		...
		// LED 3 logic
		if ((outputLeft > 32767)||(outputLeft < -32768)||(outputRight > 32767)||(outputRight < -32768)) {
