...
float x = 0.0;   // input value (buffered)
float y = 0.0;   // output values (buffered)
...
{                    
	...
	/* I added my DF-II IIR filter routine here */
	x = CodecDataIn.Channel[LEFT];		// current input value ... only the LEFT channel is filtered
	...
	/* end of my DF-II IIR filter routine */
